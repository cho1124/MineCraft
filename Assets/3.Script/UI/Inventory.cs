...
public class Inventory : MonoBehaviour
{
    ...
    [Header("조합 슬롯"), SerializeField] Transform[] crafting_slot;
    [Header("조합 슬롯 결과"), SerializeField] GameObject new_item_obj;
    [Header("팝업"), SerializeField] GameObject on_off_obj;
